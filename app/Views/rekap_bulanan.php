        ...
        <div class="container mx-auto">
            <div class="flex justify-between items-center mb-6">
                <div class="flex space-x-2">
                    ...
                    <a href="/rekapBulanan" class="bg-blue-600 text-white font-bold border-none py-2 px-4 rounded-lg cursor-pointer">Bulanan</a>
                    <a href="/rekapTahunan" class="bg-gray-400 text-white font-bold border-none py-2 px-4 rounded-lg cursor-pointer">Tahunan</a>
                </div>
