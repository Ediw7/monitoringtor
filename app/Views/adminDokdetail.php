                    ...
                    <div class="flex flex-wrap gap-4">
                        ...
                        <div class="flex-none w-56 p-2">
                            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                                ...
                                <!-- Detail Budgeting -->
                                <div class=" rounded-lg text-gray-700 text-lg font-bold px-4 py-2">
                                    Detail Budgeting
                                </div>
                                <div class="p-4 space-y-1">
                                    <div>
                        ...
                        <div class="flex-none w-56 p-2">
                            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                                ...
                                <!-- Uang Muka -->
                                <div class=" rounded-lg text-gray-700 text-lg font-bold px-4 py-1">Uang Muka</div>
                                <div class="p-4 space-y-1">
                                    <!-- Tanggal Uang Muka -->
                                    <div>
...
<div id="updateStatusModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-60 hidden z-50">
    <div class="bg-white rounded-lg shadow-lg p-6 w-3/4 max-w-4xl">
        <div class="flex justify-between items-center border-b pb-3">
            ...
            <button class="text-black text-2xl hover:text-gray-800 transition" onclick="closeModal('updateStatusModal')">✖</button>
        </div>
        <div class="mt-4">
